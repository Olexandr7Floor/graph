...
def visualize_graph(filtered_data, node_mentions, repeated_edges, network_clustering_coefficient, visualize):
 ...
 dot.render('output_graph', view=visualize)
...
def generate_graph():
    ...
    return G, sorted_clustering_coefficient_list, node_counts, filtered_data, edges_by_node, network_density, network_clustering_coefficient


@app.route('/')
def index():
    G, sorted_clustering_coefficient_list, node_counts, filtered_data, edges_by_node, network_density, network_clustering_coefficient = generate_graph()

    graph_info = {
        'G': G,
        'sorted_clustering_coefficient_list': sorted_clustering_coefficient_list,
    ...
    return render_template('index.html', graph_info=graph_info)
